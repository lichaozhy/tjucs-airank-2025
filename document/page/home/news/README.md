- **`[2025/10/06]`** 🎯 **New embodied model added:** `wall-oss-fast` from [X Square Robot](https://huggingface.co/x-square-robot/wall-oss-fast) now available for benchmarking!
